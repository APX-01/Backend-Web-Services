...
import com.education.eduhive.iam.interfaces.rest.transform.AuthenticatedUserResourceFromEntityAssembler;
import com.education.eduhive.iam.interfaces.rest.transform.SignInCommandFromResourceAssembler;
import com.education.eduhive.iam.interfaces.rest.transform.SignUpCommandFromResourceAssembler;
...
public class AuthenticationController {
    ...
    @PostMapping("/sign-in")
    @Operation(summary = "Sign in user", description = "Sign in user with email and password")
    @ApiResponses(
            value = {
